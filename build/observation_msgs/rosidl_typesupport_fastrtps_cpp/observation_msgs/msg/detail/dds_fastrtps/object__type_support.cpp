...
#include "observation_msgs/msg/detail/object__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  moveit_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.collision_object,
    cdr);
  // Member: attached_collision_object
  moveit_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.attached_collision_object,
    cdr);
  // Member: id
  cdr << ros_message.id;
  // Member: obj_group
  cdr << ros_message.obj_group;
  // Member: status
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = observation_msgs::msg::Object;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const observation_msgs::msg::Object *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<observation_msgs::msg::Object *>(
    untyped_ros_message);
...
{
  return &observation_msgs::msg::typesupport_fastrtps_cpp::_Object__handle;
}
