...
bool observation_msgs__srv__set_objects__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("observation_msgs.srv._set_objects.SetObjects_Request", full_classname_dest, 52) == 0);
  }
  observation_msgs__srv__SetObjects_Request * ros_message = _ros_message;
  {  // objects
...
{
  /* NOTE(esteve): Call constructor of SetObjects_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("observation_msgs.srv._set_objects");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetObjects_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool observation_msgs__srv__set_objects__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("observation_msgs.srv._set_objects.SetObjects_Response", full_classname_dest, 53) == 0);
  }
  observation_msgs__srv__SetObjects_Response * ros_message = _ros_message;
  {  // error_string
...
{
  /* NOTE(esteve): Call constructor of SetObjects_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("observation_msgs.srv._set_objects");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetObjects_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
