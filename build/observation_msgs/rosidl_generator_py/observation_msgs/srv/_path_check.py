...
class PathCheck_Response(metaclass=Metaclass_PathCheck_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.anomaly_score = kwargs.get('anomaly_score', int())
    ...
    def __eq__(self, other):
        ...
        if self.error_string != other.error_string:
            return False
        if self.anomaly_score != other.anomaly_score:
            return False
        return True
    ...
    def anomaly_score(self, value):
        if __debug__:
            assert \
                ...
                "The 'anomaly_score' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'anomaly_score' field must be an integer in [-128, 127]"
        self._anomaly_score = value
...
class Metaclass_PathCheck(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'observation_msgs.srv.PathCheck')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from observation_msgs.srv import _path_check
...
class PathCheck(metaclass=Metaclass_PathCheck):
    from observation_msgs.srv._path_check import PathCheck_Request as Request
    from observation_msgs.srv._path_check import PathCheck_Response as Response
