...
static const _SetObjects_Request_type_support_symbol_names_t _SetObjects_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, observation_msgs, srv, SetObjects_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, observation_msgs, srv, SetObjects_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, observation_msgs, srv, SetObjects_Request)() {
  return &::observation_msgs::srv::rosidl_typesupport_c::SetObjects_Request_message_type_support_handle;
}
...
static const _SetObjects_Response_type_support_symbol_names_t _SetObjects_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, observation_msgs, srv, SetObjects_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, observation_msgs, srv, SetObjects_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, observation_msgs, srv, SetObjects_Response)() {
  return &::observation_msgs::srv::rosidl_typesupport_c::SetObjects_Response_message_type_support_handle;
}
...
static const _SetObjects_type_support_symbol_names_t _SetObjects_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, observation_msgs, srv, SetObjects)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, observation_msgs, srv, SetObjects)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, observation_msgs, srv, SetObjects)() {
  return &::observation_msgs::srv::rosidl_typesupport_c::SetObjects_service_type_support_handle;
}
