...
#ifndef OBSERVATION_MSGS__SRV__DETAIL__PATH_CHECK__FUNCTIONS_H_
#define OBSERVATION_MSGS__SRV__DETAIL__PATH_CHECK__FUNCTIONS_H_
 ...
 * calls
 * observation_msgs__srv__PathCheck_Request__init().
...
/**
 * It calls
 * observation_msgs__srv__PathCheck_Request__fini()
 ...
 * observation_msgs__srv__PathCheck_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * observation_msgs__srv__PathCheck_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * observation_msgs__srv__PathCheck_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_observation_msgs
...
/**
 * It calls
 * observation_msgs__srv__PathCheck_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_observation_msgs
...
/**
 * It allocates the memory for the array and calls
 * observation_msgs__srv__PathCheck_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_observation_msgs
...
/**
 * It calls
 * observation_msgs__srv__PathCheck_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OBSERVATION_MSGS__SRV__DETAIL__PATH_CHECK__FUNCTIONS_H_
