...
static const _AlvarMarkers_type_support_symbol_names_t _AlvarMarkers_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ar_track_alvar_msgs, msg, AlvarMarkers)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ar_track_alvar_msgs, msg, AlvarMarkers)),
  }
};
...
{
  return &::ar_track_alvar_msgs::msg::rosidl_typesupport_cpp::AlvarMarkers_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ar_track_alvar_msgs, msg, AlvarMarkers)() {
  return get_message_type_support_handle<ar_track_alvar_msgs::msg::AlvarMarkers>();
}
