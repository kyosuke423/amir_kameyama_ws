...
#include "ar_track_alvar_msgs/msg/detail/alvar_marker__rosidl_typesupport_fastrtps_c.h"
...
using _AlvarMarker__ros_msg_type = ar_track_alvar_msgs__msg__AlvarMarker;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AlvarMarker__ros_msg_type * ros_message = static_cast<const _AlvarMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AlvarMarker__ros_msg_type * ros_message = static_cast<_AlvarMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _AlvarMarker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ar_track_alvar_msgs__msg__AlvarMarker(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ar_track_alvar_msgs__msg__AlvarMarker;
    is_plain =
      (
...
static size_t _AlvarMarker__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ar_track_alvar_msgs__msg__AlvarMarker(
...
static message_type_support_callbacks_t __callbacks_AlvarMarker = {
...
static rosidl_message_type_support_t _AlvarMarker__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AlvarMarker,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ar_track_alvar_msgs, msg, AlvarMarker)() {
  return &_AlvarMarker__type_support;
}
