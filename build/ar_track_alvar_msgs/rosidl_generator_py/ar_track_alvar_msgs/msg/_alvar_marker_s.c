...
bool ar_track_alvar_msgs__msg__alvar_marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ar_track_alvar_msgs.msg._alvar_marker.AlvarMarker", full_classname_dest, 49) == 0);
  }
  ar_track_alvar_msgs__msg__AlvarMarker * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of AlvarMarker */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ar_track_alvar_msgs.msg._alvar_marker");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AlvarMarker");
