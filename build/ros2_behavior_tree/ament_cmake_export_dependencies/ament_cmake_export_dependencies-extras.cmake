...
set(_exported_dependencies "behaviortree_cpp_v3;geometry_msgs;rclcpp;rclcpp_action;rclcpp_lifecycle;behavior_tree_msgs;std_msgs;std_srvs;tf2;tf2_geometry_msgs;tf2_ros;example_interfaces;nav2_msgs;visualization_msgs;builtin_interfaces;nav2_behavior_tree;observation_msgs;my_nav_msgs;failure_detection_msgs;nav2_util;nav_msgs")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to ros2_behavior_tree_DEFINITIONS, ros2_behavior_tree_INCLUDE_DIRS,
# ros2_behavior_tree_LIBRARIES, and ros2_behavior_tree_LINK_FLAGS.
# Additionally collect the direct dependency names in
# ros2_behavior_tree_DEPENDENCIES as well as the recursive dependency names
# in ros2_behavior_tree_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(ros2_behavior_tree_DEPENDENCIES ${_exported_dependencies})
  set(ros2_behavior_tree_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(ros2_behavior_tree_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(ros2_behavior_tree_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(ros2_behavior_tree_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(ros2_behavior_tree_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(ros2_behavior_tree_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND ros2_behavior_tree_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
