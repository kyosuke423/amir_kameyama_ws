...
#include "failure_detection_msgs/srv/detail/path_check__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = failure_detection_msgs::srv::PathCheck_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const failure_detection_msgs::srv::PathCheck_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<failure_detection_msgs::srv::PathCheck_Request *>(
    untyped_ros_message);
...
{
  return &failure_detection_msgs::srv::typesupport_fastrtps_cpp::_PathCheck_Request__handle;
}
  ...
  failure_detection_msgs::srv::PathCheck_Response & ros_message)
{
  ...
  // Member: info_set
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.info_set.resize(size);
    for (size_t i = 0; i < size; i++) {
      my_nav_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.info_set[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: info_set
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        my_nav_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.info_set[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = failure_detection_msgs::srv::PathCheck_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const failure_detection_msgs::srv::PathCheck_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<failure_detection_msgs::srv::PathCheck_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &failure_detection_msgs::srv::typesupport_fastrtps_cpp::_PathCheck_Response__handle;
}
...
{
  return &failure_detection_msgs::srv::typesupport_fastrtps_cpp::_PathCheck__handle;
}
