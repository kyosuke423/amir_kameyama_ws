...
failure_detection_msgs__srv__BeforePick_Request__init(failure_detection_msgs__srv__BeforePick_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->command)) {
    failure_detection_msgs__srv__BeforePick_Request__fini(msg);
    return false;
  }
  // id
...
failure_detection_msgs__srv__BeforePick_Request__create()
{
  ...
  failure_detection_msgs__srv__BeforePick_Request * msg = (failure_detection_msgs__srv__BeforePick_Request *)allocator.allocate(sizeof(failure_detection_msgs__srv__BeforePick_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(failure_detection_msgs__srv__BeforePick_Request));
  bool success = failure_detection_msgs__srv__BeforePick_Request__init(msg);
  if (!success) {
...
failure_detection_msgs__srv__BeforePick_Request__Sequence__init(failure_detection_msgs__srv__BeforePick_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  failure_detection_msgs__srv__BeforePick_Request * data = NULL;

  if (size) {
    data = (failure_detection_msgs__srv__BeforePick_Request *)allocator.zero_allocate(size, sizeof(failure_detection_msgs__srv__BeforePick_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = failure_detection_msgs__srv__BeforePick_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        failure_detection_msgs__srv__BeforePick_Request__fini(&data[i - 1]);
      }
...
failure_detection_msgs__srv__BeforePick_Request__Sequence__fini(failure_detection_msgs__srv__BeforePick_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      failure_detection_msgs__srv__BeforePick_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  failure_detection_msgs__srv__BeforePick_Request__Sequence * array = (failure_detection_msgs__srv__BeforePick_Request__Sequence *)allocator.allocate(sizeof(failure_detection_msgs__srv__BeforePick_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = failure_detection_msgs__srv__BeforePick_Request__Sequence__init(array, size);
  if (!success) {
...
failure_detection_msgs__srv__BeforePick_Request__Sequence__destroy(failure_detection_msgs__srv__BeforePick_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    failure_detection_msgs__srv__BeforePick_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
failure_detection_msgs__srv__BeforePick_Request__Sequence__are_equal(const failure_detection_msgs__srv__BeforePick_Request__Sequence * lhs, const failure_detection_msgs__srv__BeforePick_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!failure_detection_msgs__srv__BeforePick_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  failure_detection_msgs__srv__BeforePick_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(failure_detection_msgs__srv__BeforePick_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    failure_detection_msgs__srv__BeforePick_Request * data =
      (failure_detection_msgs__srv__BeforePick_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!failure_detection_msgs__srv__BeforePick_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          failure_detection_msgs__srv__BeforePick_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!failure_detection_msgs__srv__BeforePick_Request__copy(
...
failure_detection_msgs__srv__BeforePick_Response__init(failure_detection_msgs__srv__BeforePick_Response * msg)
{
  ...
  // command
  if (!rosidl_runtime_c__String__init(&msg->command)) {
    failure_detection_msgs__srv__BeforePick_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  failure_detection_msgs__srv__BeforePick_Response * msg = (failure_detection_msgs__srv__BeforePick_Response *)allocator.allocate(sizeof(failure_detection_msgs__srv__BeforePick_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(failure_detection_msgs__srv__BeforePick_Response));
  bool success = failure_detection_msgs__srv__BeforePick_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
failure_detection_msgs__srv__BeforePick_Response__Sequence__init(failure_detection_msgs__srv__BeforePick_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  failure_detection_msgs__srv__BeforePick_Response * data = NULL;

  if (size) {
    data = (failure_detection_msgs__srv__BeforePick_Response *)allocator.zero_allocate(size, sizeof(failure_detection_msgs__srv__BeforePick_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = failure_detection_msgs__srv__BeforePick_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        failure_detection_msgs__srv__BeforePick_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
failure_detection_msgs__srv__BeforePick_Response__Sequence__fini(failure_detection_msgs__srv__BeforePick_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      failure_detection_msgs__srv__BeforePick_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  failure_detection_msgs__srv__BeforePick_Response__Sequence * array = (failure_detection_msgs__srv__BeforePick_Response__Sequence *)allocator.allocate(sizeof(failure_detection_msgs__srv__BeforePick_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = failure_detection_msgs__srv__BeforePick_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
failure_detection_msgs__srv__BeforePick_Response__Sequence__destroy(failure_detection_msgs__srv__BeforePick_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    failure_detection_msgs__srv__BeforePick_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
failure_detection_msgs__srv__BeforePick_Response__Sequence__are_equal(const failure_detection_msgs__srv__BeforePick_Response__Sequence * lhs, const failure_detection_msgs__srv__BeforePick_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!failure_detection_msgs__srv__BeforePick_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  failure_detection_msgs__srv__BeforePick_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(failure_detection_msgs__srv__BeforePick_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    failure_detection_msgs__srv__BeforePick_Response * data =
      (failure_detection_msgs__srv__BeforePick_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!failure_detection_msgs__srv__BeforePick_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          failure_detection_msgs__srv__BeforePick_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!failure_detection_msgs__srv__BeforePick_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
