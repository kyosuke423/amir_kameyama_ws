...
#ifndef FAILURE_DETECTION_MSGS__SRV__DETAIL__AFTER_PICK__FUNCTIONS_H_
#define FAILURE_DETECTION_MSGS__SRV__DETAIL__AFTER_PICK__FUNCTIONS_H_
...
/// Initialize srv/AfterPick message.
/**
...
/// Finalize srv/AfterPick message.
/**
...
/// Create srv/AfterPick message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * failure_detection_msgs__srv__AfterPick_Request__init().
...
/// Destroy srv/AfterPick message.
/**
 * It calls
 * failure_detection_msgs__srv__AfterPick_Request__fini()
...
/// Check for srv/AfterPick message equality.
/**
...
/// Initialize array of srv/AfterPick messages.
/**
...
/// Finalize array of srv/AfterPick messages.
/**
 * It calls
 * failure_detection_msgs__srv__AfterPick_Request__fini()
...
/// Create array of srv/AfterPick messages.
/**
 * It allocates the memory for the array and calls
 * failure_detection_msgs__srv__AfterPick_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AfterPick messages.
/**
 * It calls
 * failure_detection_msgs__srv__AfterPick_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AfterPick message array equality.
/**
...
/// Copy an array of srv/AfterPick messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * failure_detection_msgs__srv__AfterPick_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_failure_detection_msgs
...
/**
 * It calls
 * failure_detection_msgs__srv__AfterPick_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_failure_detection_msgs
...
/**
 * It allocates the memory for the array and calls
 * failure_detection_msgs__srv__AfterPick_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_failure_detection_msgs
...
/**
 * It calls
 * failure_detection_msgs__srv__AfterPick_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FAILURE_DETECTION_MSGS__SRV__DETAIL__AFTER_PICK__FUNCTIONS_H_
