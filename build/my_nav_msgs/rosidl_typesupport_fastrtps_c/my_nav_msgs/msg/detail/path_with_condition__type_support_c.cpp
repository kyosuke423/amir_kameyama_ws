...
#include "my_nav_msgs/msg/detail/path_with_condition__rosidl_typesupport_fastrtps_c.h"
...
#include "my_nav_msgs/msg/detail/path_info__functions.h"  // info
...
using _PathWithCondition__ros_msg_type = my_nav_msgs__msg__PathWithCondition;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PathWithCondition__ros_msg_type * ros_message = static_cast<const _PathWithCondition__ros_msg_type *>(untyped_ros_message);
  // Field name: path
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PathWithCondition__ros_msg_type * ros_message = static_cast<_PathWithCondition__ros_msg_type *>(untyped_ros_message);
  // Field name: path
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _PathWithCondition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_nav_msgs__msg__PathWithCondition(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_nav_msgs__msg__PathWithCondition;
    is_plain =
      (
...
static size_t _PathWithCondition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_nav_msgs__msg__PathWithCondition(
...
static message_type_support_callbacks_t __callbacks_PathWithCondition = {
  "my_nav_msgs::msg",
  "PathWithCondition",
...
static rosidl_message_type_support_t _PathWithCondition__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PathWithCondition,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_nav_msgs, msg, PathWithCondition)() {
  return &_PathWithCondition__type_support;
}
