...
line_msg__msg__BoxCorner__init(line_msg__msg__BoxCorner * msg)
{
  ...
  if (!geometry_msgs__msg__Pose__init(&msg->posi)) {
    line_msg__msg__BoxCorner__fini(msg);
    return false;
  }
  return true;
}
...
line_msg__msg__BoxCorner__create()
{
  ...
  line_msg__msg__BoxCorner * msg = (line_msg__msg__BoxCorner *)allocator.allocate(sizeof(line_msg__msg__BoxCorner), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(line_msg__msg__BoxCorner));
  bool success = line_msg__msg__BoxCorner__init(msg);
  if (!success) {
...
line_msg__msg__BoxCorner__Sequence__init(line_msg__msg__BoxCorner__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  line_msg__msg__BoxCorner * data = NULL;

  if (size) {
    data = (line_msg__msg__BoxCorner *)allocator.zero_allocate(size, sizeof(line_msg__msg__BoxCorner), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = line_msg__msg__BoxCorner__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        line_msg__msg__BoxCorner__fini(&data[i - 1]);
      }
...
line_msg__msg__BoxCorner__Sequence__fini(line_msg__msg__BoxCorner__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      line_msg__msg__BoxCorner__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  line_msg__msg__BoxCorner__Sequence * array = (line_msg__msg__BoxCorner__Sequence *)allocator.allocate(sizeof(line_msg__msg__BoxCorner__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = line_msg__msg__BoxCorner__Sequence__init(array, size);
  if (!success) {
...
line_msg__msg__BoxCorner__Sequence__destroy(line_msg__msg__BoxCorner__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    line_msg__msg__BoxCorner__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
line_msg__msg__BoxCorner__Sequence__are_equal(const line_msg__msg__BoxCorner__Sequence * lhs, const line_msg__msg__BoxCorner__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!line_msg__msg__BoxCorner__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  line_msg__msg__BoxCorner__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(line_msg__msg__BoxCorner);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    line_msg__msg__BoxCorner * data =
      (line_msg__msg__BoxCorner *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!line_msg__msg__BoxCorner__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          line_msg__msg__BoxCorner__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!line_msg__msg__BoxCorner__copy(
