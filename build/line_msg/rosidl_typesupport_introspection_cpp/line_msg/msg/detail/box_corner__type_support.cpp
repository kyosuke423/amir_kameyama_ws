...
{
  new (message_memory) line_msg::msg::BoxCorner(_init);
}

void BoxCorner_fini_function(void * message_memory)
{
  auto typed_message = static_cast<line_msg::msg::BoxCorner *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoxCorner_message_member_array[3] = {
  {
    ...
    offsetof(line_msg::msg::BoxCorner, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(line_msg::msg::BoxCorner, corner_num),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(line_msg::msg::BoxCorner, posi),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoxCorner_message_members = {
  "line_msg::msg",  // message namespace
  "BoxCorner",  // message name
  3,  // number of fields
  sizeof(line_msg::msg::BoxCorner),
...
{
  return &::line_msg::msg::rosidl_typesupport_introspection_cpp::BoxCorner_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, line_msg, msg, BoxCorner)() {
  return &::line_msg::msg::rosidl_typesupport_introspection_cpp::BoxCorner_message_type_support_handle;
}
