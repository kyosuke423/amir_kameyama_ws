...
#include "line_msg/msg/detail/box_corner__rosidl_typesupport_fastrtps_c.h"
...
#include "line_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_line_msg
...
using _BoxCorner__ros_msg_type = line_msg__msg__BoxCorner;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_line_msg
size_t get_serialized_size_line_msg__msg__BoxCorner(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoxCorner__ros_msg_type * ros_message = static_cast<const _BoxCorner__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BoxCorner__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_line_msg__msg__BoxCorner(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_line_msg
size_t max_serialized_size_line_msg__msg__BoxCorner(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = line_msg__msg__BoxCorner;
    is_plain =
      (
...
static size_t _BoxCorner__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_line_msg__msg__BoxCorner(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, line_msg, msg, BoxCorner)() {
