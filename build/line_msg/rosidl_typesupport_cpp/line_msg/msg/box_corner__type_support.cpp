...
static const _BoxCorner_type_support_symbol_names_t _BoxCorner_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, line_msg, msg, BoxCorner)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, line_msg, msg, BoxCorner)),
  }
};
...
{
  return &::line_msg::msg::rosidl_typesupport_cpp::BoxCorner_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, line_msg, msg, BoxCorner)() {
  return get_message_type_support_handle<line_msg::msg::BoxCorner>();
}
