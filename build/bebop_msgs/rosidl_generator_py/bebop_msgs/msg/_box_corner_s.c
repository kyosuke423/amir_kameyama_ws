...
bool bebop_msgs__msg__box_corner__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bebop_msgs.msg._box_corner.BoxCorner", full_classname_dest, 36) == 0);
  }
  bebop_msgs__msg__BoxCorner * ros_message = _ros_message;
  {  // id
...
PyObject * bebop_msgs__msg__box_corner__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("bebop_msgs.msg._box_corner");
