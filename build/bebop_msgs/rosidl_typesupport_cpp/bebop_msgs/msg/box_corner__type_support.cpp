...
static const _BoxCorner_type_support_symbol_names_t _BoxCorner_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bebop_msgs, msg, BoxCorner)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bebop_msgs, msg, BoxCorner)),
  }
};
...
{
  return &::bebop_msgs::msg::rosidl_typesupport_cpp::BoxCorner_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bebop_msgs, msg, BoxCorner)() {
  return get_message_type_support_handle<bebop_msgs::msg::BoxCorner>();
}
