...
static const _BoxCorner_type_support_symbol_names_t _BoxCorner_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bebop_msgs, msg, BoxCorner)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bebop_msgs, msg, BoxCorner)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bebop_msgs, msg, BoxCorner)() {
  return &::bebop_msgs::msg::rosidl_typesupport_c::BoxCorner_message_type_support_handle;
}
