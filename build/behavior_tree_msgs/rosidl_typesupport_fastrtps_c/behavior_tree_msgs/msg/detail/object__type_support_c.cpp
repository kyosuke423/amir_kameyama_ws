...
#include "behavior_tree_msgs/msg/detail/object__rosidl_typesupport_fastrtps_c.h"
...
#include "behavior_tree_msgs/msg/detail/pixel__functions.h"  // pixel_bottom_right, pixel_center, pixel_top_left
#include "geometry_msgs/msg/detail/pose__functions.h"  // from_base, from_camera, from_odom
...
using _Object__ros_msg_type = behavior_tree_msgs__msg__Object;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: from_camera
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->from_camera, cdr))
    {
      return false;
    }
  }

  // Field name: from_base
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->from_base, cdr))
    {
      return false;
    }
  }

  // Field name: from_odom
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  // Field name: pixel_bottom_right
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, behavior_tree_msgs, msg, Pixel
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->pixel_bottom_right, cdr))
    {
      return false;
    }
  }

  // Field name: pixel_top_left
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->pixel_top_left, cdr))
    {
      return false;
    }
  }

  // Field name: pixel_center
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_behavior_tree_msgs__msg__Pixel(
...
static uint32_t _Object__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_tree_msgs__msg__Object(
  ...
  size_t current_alignment)
{
  ...
  // member: pixel_bottom_right
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_behavior_tree_msgs__msg__Pixel(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = behavior_tree_msgs__msg__Object;
    is_plain =
      (
...
static size_t _Object__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_tree_msgs__msg__Object(
