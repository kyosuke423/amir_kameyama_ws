...
#include "behavior_tree_msgs/msg/detail/bb_float64_array__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/float64_multi_array__functions.h"  // value
...
using _BBFloat64Array__ros_msg_type = behavior_tree_msgs__msg__BBFloat64Array;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BBFloat64Array__ros_msg_type * ros_message = static_cast<const _BBFloat64Array__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
  ...
  void * untyped_ros_message)
{
  ...
  _BBFloat64Array__ros_msg_type * ros_message = static_cast<_BBFloat64Array__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _BBFloat64Array__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_tree_msgs__msg__BBFloat64Array(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = behavior_tree_msgs__msg__BBFloat64Array;
    is_plain =
      (
...
static size_t _BBFloat64Array__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_tree_msgs__msg__BBFloat64Array(
...
static message_type_support_callbacks_t __callbacks_BBFloat64Array = {
...
static rosidl_message_type_support_t _BBFloat64Array__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BBFloat64Array,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_tree_msgs, msg, BBFloat64Array)() {
  return &_BBFloat64Array__type_support;
}
