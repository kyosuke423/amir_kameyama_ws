...
#include "behavior_tree_msgs/msg/detail/bb_path__rosidl_typesupport_fastrtps_c.h"
...
#include "nav_msgs/msg/detail/path__functions.h"  // value
...
using _BBPath__ros_msg_type = behavior_tree_msgs__msg__BBPath;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BBPath__ros_msg_type * ros_message = static_cast<const _BBPath__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
  ...
  void * untyped_ros_message)
{
  ...
  _BBPath__ros_msg_type * ros_message = static_cast<_BBPath__ros_msg_type *>(untyped_ros_message);
  // Field name: key
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _BBPath__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_tree_msgs__msg__BBPath(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = behavior_tree_msgs__msg__BBPath;
    is_plain =
      (
...
static size_t _BBPath__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_tree_msgs__msg__BBPath(
...
static message_type_support_callbacks_t __callbacks_BBPath = {
...
static rosidl_message_type_support_t _BBPath__type_support = {
