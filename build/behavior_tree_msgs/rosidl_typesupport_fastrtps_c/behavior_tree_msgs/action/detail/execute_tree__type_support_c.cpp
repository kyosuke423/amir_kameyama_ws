...
#include "behavior_tree_msgs/action/detail/execute_tree__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // bt, id
#include "rosidl_runtime_c/string_functions.h"  // bt, id

// forward declare type support functions


using _ExecuteTree_Goal__ros_msg_type = behavior_tree_msgs__action__ExecuteTree_Goal;
...
size_t get_serialized_size_behavior_tree_msgs__action__ExecuteTree_Goal(
  const void * untyped_ros_message,
...
static uint32_t _ExecuteTree_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_tree_msgs__action__ExecuteTree_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t max_serialized_size_behavior_tree_msgs__action__ExecuteTree_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = behavior_tree_msgs__action__ExecuteTree_Goal;
    is_plain =
      (
...
static size_t _ExecuteTree_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_tree_msgs__action__ExecuteTree_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_Goal)() {
...
#include "behavior_tree_msgs/msg/detail/bt_status__functions.h"  // bt_status
// already included above
...
using _ExecuteTree_Result__ros_msg_type = behavior_tree_msgs__action__ExecuteTree_Result;
  ...
  // Field name: bt_status
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, behavior_tree_msgs, msg, BTStatus
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->bt_status, cdr))
    {
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t get_serialized_size_behavior_tree_msgs__action__ExecuteTree_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTree_Result__ros_msg_type * ros_message = static_cast<const _ExecuteTree_Result__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_behavior_tree_msgs__msg__BTStatus(
    &(ros_message->bt_status), current_alignment);
  // field.name error_string
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
...
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_tree_msgs__action__ExecuteTree_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t max_serialized_size_behavior_tree_msgs__action__ExecuteTree_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: bt_status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_behavior_tree_msgs__msg__BTStatus(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = behavior_tree_msgs__action__ExecuteTree_Result;
    is_plain =
      (
...
static size_t _ExecuteTree_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_tree_msgs__action__ExecuteTree_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_Result)() {
...
using _ExecuteTree_Feedback__ros_msg_type = behavior_tree_msgs__action__ExecuteTree_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t get_serialized_size_behavior_tree_msgs__action__ExecuteTree_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTree_Feedback__ros_msg_type * ros_message = static_cast<const _ExecuteTree_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_tree_msgs__action__ExecuteTree_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t max_serialized_size_behavior_tree_msgs__action__ExecuteTree_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = behavior_tree_msgs__action__ExecuteTree_Feedback;
    is_plain =
      (
...
static size_t _ExecuteTree_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_tree_msgs__action__ExecuteTree_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_Feedback)() {
...
// already included above
// #include "behavior_tree_msgs/action/detail/execute_tree__functions.h"  // goal
...
using _ExecuteTree_SendGoal_Request__ros_msg_type = behavior_tree_msgs__action__ExecuteTree_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t get_serialized_size_behavior_tree_msgs__action__ExecuteTree_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTree_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _ExecuteTree_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_behavior_tree_msgs__action__ExecuteTree_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_tree_msgs__action__ExecuteTree_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t max_serialized_size_behavior_tree_msgs__action__ExecuteTree_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_behavior_tree_msgs__action__ExecuteTree_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = behavior_tree_msgs__action__ExecuteTree_SendGoal_Request;
    is_plain =
      (
...
static size_t _ExecuteTree_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_tree_msgs__action__ExecuteTree_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_SendGoal_Request)() {
...
using _ExecuteTree_SendGoal_Response__ros_msg_type = behavior_tree_msgs__action__ExecuteTree_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t get_serialized_size_behavior_tree_msgs__action__ExecuteTree_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTree_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _ExecuteTree_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_tree_msgs__action__ExecuteTree_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t max_serialized_size_behavior_tree_msgs__action__ExecuteTree_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = behavior_tree_msgs__action__ExecuteTree_SendGoal_Response;
    is_plain =
      (
...
static size_t _ExecuteTree_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_tree_msgs__action__ExecuteTree_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_SendGoal)() {
...
using _ExecuteTree_GetResult_Request__ros_msg_type = behavior_tree_msgs__action__ExecuteTree_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t get_serialized_size_behavior_tree_msgs__action__ExecuteTree_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTree_GetResult_Request__ros_msg_type * ros_message = static_cast<const _ExecuteTree_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_tree_msgs__action__ExecuteTree_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t max_serialized_size_behavior_tree_msgs__action__ExecuteTree_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = behavior_tree_msgs__action__ExecuteTree_GetResult_Request;
    is_plain =
      (
...
static size_t _ExecuteTree_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_tree_msgs__action__ExecuteTree_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_GetResult_Request)() {
...
// already included above
// #include "behavior_tree_msgs/action/detail/execute_tree__functions.h"  // result
...
using _ExecuteTree_GetResult_Response__ros_msg_type = behavior_tree_msgs__action__ExecuteTree_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t get_serialized_size_behavior_tree_msgs__action__ExecuteTree_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTree_GetResult_Response__ros_msg_type * ros_message = static_cast<const _ExecuteTree_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_behavior_tree_msgs__action__ExecuteTree_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_tree_msgs__action__ExecuteTree_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t max_serialized_size_behavior_tree_msgs__action__ExecuteTree_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_behavior_tree_msgs__action__ExecuteTree_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = behavior_tree_msgs__action__ExecuteTree_GetResult_Response;
    is_plain =
      (
...
static size_t _ExecuteTree_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_tree_msgs__action__ExecuteTree_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_GetResult)() {
...
// already included above
// #include "behavior_tree_msgs/action/detail/execute_tree__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _ExecuteTree_FeedbackMessage__ros_msg_type = behavior_tree_msgs__action__ExecuteTree_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t get_serialized_size_behavior_tree_msgs__action__ExecuteTree_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTree_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _ExecuteTree_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_behavior_tree_msgs__action__ExecuteTree_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_tree_msgs__action__ExecuteTree_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_tree_msgs
size_t max_serialized_size_behavior_tree_msgs__action__ExecuteTree_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_behavior_tree_msgs__action__ExecuteTree_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = behavior_tree_msgs__action__ExecuteTree_FeedbackMessage;
    is_plain =
      (
...
static size_t _ExecuteTree_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_tree_msgs__action__ExecuteTree_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_tree_msgs, action, ExecuteTree_FeedbackMessage)() {
