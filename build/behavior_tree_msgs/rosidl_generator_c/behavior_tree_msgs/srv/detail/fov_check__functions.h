...
#ifndef BEHAVIOR_TREE_MSGS__SRV__DETAIL__FOV_CHECK__FUNCTIONS_H_
#define BEHAVIOR_TREE_MSGS__SRV__DETAIL__FOV_CHECK__FUNCTIONS_H_
...
/// Initialize srv/FovCheck message.
/**
...
/// Create srv/FovCheck message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * behavior_tree_msgs__srv__FovCheck_Request__init().
...
/// Destroy srv/FovCheck message.
/**
 * It calls
 * behavior_tree_msgs__srv__FovCheck_Request__fini()
...
/// Check for srv/FovCheck message equality.
/**
...
/// Initialize array of srv/FovCheck messages.
/**
...
/// Finalize array of srv/FovCheck messages.
/**
 * It calls
 * behavior_tree_msgs__srv__FovCheck_Request__fini()
...
/// Create array of srv/FovCheck messages.
/**
 * It allocates the memory for the array and calls
 * behavior_tree_msgs__srv__FovCheck_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FovCheck messages.
/**
 * It calls
 * behavior_tree_msgs__srv__FovCheck_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/FovCheck message array equality.
/**
...
/// Copy an array of srv/FovCheck messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * behavior_tree_msgs__srv__FovCheck_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_behavior_tree_msgs
...
/**
 * It calls
 * behavior_tree_msgs__srv__FovCheck_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_behavior_tree_msgs
...
/**
 * It allocates the memory for the array and calls
 * behavior_tree_msgs__srv__FovCheck_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_behavior_tree_msgs
...
/**
 * It calls
 * behavior_tree_msgs__srv__FovCheck_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BEHAVIOR_TREE_MSGS__SRV__DETAIL__FOV_CHECK__FUNCTIONS_H_
