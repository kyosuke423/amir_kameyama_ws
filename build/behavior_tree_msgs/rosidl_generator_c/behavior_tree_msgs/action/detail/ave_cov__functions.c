...
behavior_tree_msgs__action__AveCov_Goal__init(behavior_tree_msgs__action__AveCov_Goal * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->input_csv_path)) {
    behavior_tree_msgs__action__AveCov_Goal__fini(msg);
    return false;
  }
  // output_csv_path
  if (!rosidl_runtime_c__String__init(&msg->output_csv_path)) {
    behavior_tree_msgs__action__AveCov_Goal__fini(msg);
    return false;
  }
  return true;
...
behavior_tree_msgs__action__AveCov_Goal__fini(behavior_tree_msgs__action__AveCov_Goal * msg)
{
  ...
  // output_csv_path
  rosidl_runtime_c__String__fini(&msg->output_csv_path);
}
...
behavior_tree_msgs__action__AveCov_Goal__are_equal(const behavior_tree_msgs__action__AveCov_Goal * lhs, const behavior_tree_msgs__action__AveCov_Goal * rhs)
{
  ...
  // output_csv_path
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->output_csv_path), &(rhs->output_csv_path)))
  {
    return false;
  }
  return true;
  ...
  behavior_tree_msgs__action__AveCov_Goal * output)
{
  ...
  // output_csv_path
  if (!rosidl_runtime_c__String__copy(
      &(input->output_csv_path), &(output->output_csv_path)))
  {
    return false;
  }
  return true;
...
behavior_tree_msgs__action__AveCov_Goal__create()
{
  ...
  behavior_tree_msgs__action__AveCov_Goal * msg = (behavior_tree_msgs__action__AveCov_Goal *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(behavior_tree_msgs__action__AveCov_Goal));
  bool success = behavior_tree_msgs__action__AveCov_Goal__init(msg);
  if (!success) {
...
behavior_tree_msgs__action__AveCov_Goal__Sequence__init(behavior_tree_msgs__action__AveCov_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_Goal * data = NULL;

  if (size) {
    data = (behavior_tree_msgs__action__AveCov_Goal *)allocator.zero_allocate(size, sizeof(behavior_tree_msgs__action__AveCov_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = behavior_tree_msgs__action__AveCov_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        behavior_tree_msgs__action__AveCov_Goal__fini(&data[i - 1]);
      }
...
behavior_tree_msgs__action__AveCov_Goal__Sequence__fini(behavior_tree_msgs__action__AveCov_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      behavior_tree_msgs__action__AveCov_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_Goal__Sequence * array = (behavior_tree_msgs__action__AveCov_Goal__Sequence *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = behavior_tree_msgs__action__AveCov_Goal__Sequence__init(array, size);
  if (!success) {
...
behavior_tree_msgs__action__AveCov_Goal__Sequence__destroy(behavior_tree_msgs__action__AveCov_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    behavior_tree_msgs__action__AveCov_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
behavior_tree_msgs__action__AveCov_Goal__Sequence__are_equal(const behavior_tree_msgs__action__AveCov_Goal__Sequence * lhs, const behavior_tree_msgs__action__AveCov_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  behavior_tree_msgs__action__AveCov_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(behavior_tree_msgs__action__AveCov_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    behavior_tree_msgs__action__AveCov_Goal * data =
      (behavior_tree_msgs__action__AveCov_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!behavior_tree_msgs__action__AveCov_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          behavior_tree_msgs__action__AveCov_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_Goal__copy(
...
behavior_tree_msgs__action__AveCov_Result__init(behavior_tree_msgs__action__AveCov_Result * msg)
{
  ...
  // success
  // output_backup_path
  if (!rosidl_runtime_c__String__init(&msg->output_backup_path)) {
    behavior_tree_msgs__action__AveCov_Result__fini(msg);
    return false;
  }
  return true;
}
...
behavior_tree_msgs__action__AveCov_Result__fini(behavior_tree_msgs__action__AveCov_Result * msg)
{
  ...
  // success
  // output_backup_path
  rosidl_runtime_c__String__fini(&msg->output_backup_path);
}
...
behavior_tree_msgs__action__AveCov_Result__are_equal(const behavior_tree_msgs__action__AveCov_Result * lhs, const behavior_tree_msgs__action__AveCov_Result * rhs)
{
  ...
  // output_backup_path
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->output_backup_path), &(rhs->output_backup_path)))
  {
    return false;
  }
  return true;
  ...
  behavior_tree_msgs__action__AveCov_Result * output)
{
  ...
  // output_backup_path
  if (!rosidl_runtime_c__String__copy(
      &(input->output_backup_path), &(output->output_backup_path)))
  {
    return false;
  }
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_Result * msg = (behavior_tree_msgs__action__AveCov_Result *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(behavior_tree_msgs__action__AveCov_Result));
  bool success = behavior_tree_msgs__action__AveCov_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_Result__Sequence__init(behavior_tree_msgs__action__AveCov_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_Result * data = NULL;

  if (size) {
    data = (behavior_tree_msgs__action__AveCov_Result *)allocator.zero_allocate(size, sizeof(behavior_tree_msgs__action__AveCov_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = behavior_tree_msgs__action__AveCov_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        behavior_tree_msgs__action__AveCov_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
behavior_tree_msgs__action__AveCov_Result__Sequence__fini(behavior_tree_msgs__action__AveCov_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      behavior_tree_msgs__action__AveCov_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_Result__Sequence * array = (behavior_tree_msgs__action__AveCov_Result__Sequence *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = behavior_tree_msgs__action__AveCov_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_Result__Sequence__destroy(behavior_tree_msgs__action__AveCov_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    behavior_tree_msgs__action__AveCov_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
behavior_tree_msgs__action__AveCov_Result__Sequence__are_equal(const behavior_tree_msgs__action__AveCov_Result__Sequence * lhs, const behavior_tree_msgs__action__AveCov_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  behavior_tree_msgs__action__AveCov_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(behavior_tree_msgs__action__AveCov_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    behavior_tree_msgs__action__AveCov_Result * data =
      (behavior_tree_msgs__action__AveCov_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!behavior_tree_msgs__action__AveCov_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          behavior_tree_msgs__action__AveCov_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
behavior_tree_msgs__action__AveCov_Feedback__init(behavior_tree_msgs__action__AveCov_Feedback * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->current_step)) {
    behavior_tree_msgs__action__AveCov_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_Feedback * msg = (behavior_tree_msgs__action__AveCov_Feedback *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(behavior_tree_msgs__action__AveCov_Feedback));
  bool success = behavior_tree_msgs__action__AveCov_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_Feedback__Sequence__init(behavior_tree_msgs__action__AveCov_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_Feedback * data = NULL;

  if (size) {
    data = (behavior_tree_msgs__action__AveCov_Feedback *)allocator.zero_allocate(size, sizeof(behavior_tree_msgs__action__AveCov_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = behavior_tree_msgs__action__AveCov_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        behavior_tree_msgs__action__AveCov_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
behavior_tree_msgs__action__AveCov_Feedback__Sequence__fini(behavior_tree_msgs__action__AveCov_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      behavior_tree_msgs__action__AveCov_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_Feedback__Sequence * array = (behavior_tree_msgs__action__AveCov_Feedback__Sequence *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = behavior_tree_msgs__action__AveCov_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_Feedback__Sequence__destroy(behavior_tree_msgs__action__AveCov_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    behavior_tree_msgs__action__AveCov_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
behavior_tree_msgs__action__AveCov_Feedback__Sequence__are_equal(const behavior_tree_msgs__action__AveCov_Feedback__Sequence * lhs, const behavior_tree_msgs__action__AveCov_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  behavior_tree_msgs__action__AveCov_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(behavior_tree_msgs__action__AveCov_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    behavior_tree_msgs__action__AveCov_Feedback * data =
      (behavior_tree_msgs__action__AveCov_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!behavior_tree_msgs__action__AveCov_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          behavior_tree_msgs__action__AveCov_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
behavior_tree_msgs__action__AveCov_SendGoal_Request__init(behavior_tree_msgs__action__AveCov_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    behavior_tree_msgs__action__AveCov_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!behavior_tree_msgs__action__AveCov_Goal__init(&msg->goal)) {
    behavior_tree_msgs__action__AveCov_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
behavior_tree_msgs__action__AveCov_SendGoal_Request__fini(behavior_tree_msgs__action__AveCov_SendGoal_Request * msg)
{
  ...
  // goal
  behavior_tree_msgs__action__AveCov_Goal__fini(&msg->goal);
}
...
behavior_tree_msgs__action__AveCov_SendGoal_Request__are_equal(const behavior_tree_msgs__action__AveCov_SendGoal_Request * lhs, const behavior_tree_msgs__action__AveCov_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!behavior_tree_msgs__action__AveCov_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_SendGoal_Request * msg = (behavior_tree_msgs__action__AveCov_SendGoal_Request *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(behavior_tree_msgs__action__AveCov_SendGoal_Request));
  bool success = behavior_tree_msgs__action__AveCov_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence__init(behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_SendGoal_Request * data = NULL;

  if (size) {
    data = (behavior_tree_msgs__action__AveCov_SendGoal_Request *)allocator.zero_allocate(size, sizeof(behavior_tree_msgs__action__AveCov_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = behavior_tree_msgs__action__AveCov_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        behavior_tree_msgs__action__AveCov_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence__fini(behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      behavior_tree_msgs__action__AveCov_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence * array = (behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence__destroy(behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence__are_equal(const behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence * lhs, const behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  behavior_tree_msgs__action__AveCov_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(behavior_tree_msgs__action__AveCov_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    behavior_tree_msgs__action__AveCov_SendGoal_Request * data =
      (behavior_tree_msgs__action__AveCov_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!behavior_tree_msgs__action__AveCov_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          behavior_tree_msgs__action__AveCov_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
behavior_tree_msgs__action__AveCov_SendGoal_Response__init(behavior_tree_msgs__action__AveCov_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    behavior_tree_msgs__action__AveCov_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_SendGoal_Response * msg = (behavior_tree_msgs__action__AveCov_SendGoal_Response *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(behavior_tree_msgs__action__AveCov_SendGoal_Response));
  bool success = behavior_tree_msgs__action__AveCov_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence__init(behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_SendGoal_Response * data = NULL;

  if (size) {
    data = (behavior_tree_msgs__action__AveCov_SendGoal_Response *)allocator.zero_allocate(size, sizeof(behavior_tree_msgs__action__AveCov_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = behavior_tree_msgs__action__AveCov_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        behavior_tree_msgs__action__AveCov_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence__fini(behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      behavior_tree_msgs__action__AveCov_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence * array = (behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence__destroy(behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence__are_equal(const behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence * lhs, const behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  behavior_tree_msgs__action__AveCov_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(behavior_tree_msgs__action__AveCov_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    behavior_tree_msgs__action__AveCov_SendGoal_Response * data =
      (behavior_tree_msgs__action__AveCov_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!behavior_tree_msgs__action__AveCov_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          behavior_tree_msgs__action__AveCov_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
behavior_tree_msgs__action__AveCov_GetResult_Request__init(behavior_tree_msgs__action__AveCov_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    behavior_tree_msgs__action__AveCov_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_GetResult_Request * msg = (behavior_tree_msgs__action__AveCov_GetResult_Request *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(behavior_tree_msgs__action__AveCov_GetResult_Request));
  bool success = behavior_tree_msgs__action__AveCov_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence__init(behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_GetResult_Request * data = NULL;

  if (size) {
    data = (behavior_tree_msgs__action__AveCov_GetResult_Request *)allocator.zero_allocate(size, sizeof(behavior_tree_msgs__action__AveCov_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = behavior_tree_msgs__action__AveCov_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        behavior_tree_msgs__action__AveCov_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence__fini(behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      behavior_tree_msgs__action__AveCov_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence * array = (behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence__destroy(behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence__are_equal(const behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence * lhs, const behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  behavior_tree_msgs__action__AveCov_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(behavior_tree_msgs__action__AveCov_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    behavior_tree_msgs__action__AveCov_GetResult_Request * data =
      (behavior_tree_msgs__action__AveCov_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!behavior_tree_msgs__action__AveCov_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          behavior_tree_msgs__action__AveCov_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
behavior_tree_msgs__action__AveCov_GetResult_Response__init(behavior_tree_msgs__action__AveCov_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!behavior_tree_msgs__action__AveCov_Result__init(&msg->result)) {
    behavior_tree_msgs__action__AveCov_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
behavior_tree_msgs__action__AveCov_GetResult_Response__fini(behavior_tree_msgs__action__AveCov_GetResult_Response * msg)
{
  ...
  // status
  // result
  behavior_tree_msgs__action__AveCov_Result__fini(&msg->result);
}
...
behavior_tree_msgs__action__AveCov_GetResult_Response__are_equal(const behavior_tree_msgs__action__AveCov_GetResult_Response * lhs, const behavior_tree_msgs__action__AveCov_GetResult_Response * rhs)
{
  ...
  // result
  if (!behavior_tree_msgs__action__AveCov_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_GetResult_Response * msg = (behavior_tree_msgs__action__AveCov_GetResult_Response *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(behavior_tree_msgs__action__AveCov_GetResult_Response));
  bool success = behavior_tree_msgs__action__AveCov_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence__init(behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_GetResult_Response * data = NULL;

  if (size) {
    data = (behavior_tree_msgs__action__AveCov_GetResult_Response *)allocator.zero_allocate(size, sizeof(behavior_tree_msgs__action__AveCov_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = behavior_tree_msgs__action__AveCov_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        behavior_tree_msgs__action__AveCov_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence__fini(behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      behavior_tree_msgs__action__AveCov_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence * array = (behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence__destroy(behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence__are_equal(const behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence * lhs, const behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  behavior_tree_msgs__action__AveCov_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(behavior_tree_msgs__action__AveCov_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    behavior_tree_msgs__action__AveCov_GetResult_Response * data =
      (behavior_tree_msgs__action__AveCov_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!behavior_tree_msgs__action__AveCov_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          behavior_tree_msgs__action__AveCov_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
behavior_tree_msgs__action__AveCov_FeedbackMessage__init(behavior_tree_msgs__action__AveCov_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    behavior_tree_msgs__action__AveCov_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!behavior_tree_msgs__action__AveCov_Feedback__init(&msg->feedback)) {
    behavior_tree_msgs__action__AveCov_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
behavior_tree_msgs__action__AveCov_FeedbackMessage__fini(behavior_tree_msgs__action__AveCov_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  behavior_tree_msgs__action__AveCov_Feedback__fini(&msg->feedback);
}
...
behavior_tree_msgs__action__AveCov_FeedbackMessage__are_equal(const behavior_tree_msgs__action__AveCov_FeedbackMessage * lhs, const behavior_tree_msgs__action__AveCov_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!behavior_tree_msgs__action__AveCov_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_FeedbackMessage * msg = (behavior_tree_msgs__action__AveCov_FeedbackMessage *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(behavior_tree_msgs__action__AveCov_FeedbackMessage));
  bool success = behavior_tree_msgs__action__AveCov_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence__init(behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_FeedbackMessage * data = NULL;

  if (size) {
    data = (behavior_tree_msgs__action__AveCov_FeedbackMessage *)allocator.zero_allocate(size, sizeof(behavior_tree_msgs__action__AveCov_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = behavior_tree_msgs__action__AveCov_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        behavior_tree_msgs__action__AveCov_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence__fini(behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      behavior_tree_msgs__action__AveCov_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence * array = (behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence *)allocator.allocate(sizeof(behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence__destroy(behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence__are_equal(const behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence * lhs, const behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  behavior_tree_msgs__action__AveCov_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(behavior_tree_msgs__action__AveCov_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    behavior_tree_msgs__action__AveCov_FeedbackMessage * data =
      (behavior_tree_msgs__action__AveCov_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!behavior_tree_msgs__action__AveCov_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          behavior_tree_msgs__action__AveCov_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!behavior_tree_msgs__action__AveCov_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
