    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'behavior_tree_msgs.action.MoveArm_Goal')
            logger.debug(
...
class Metaclass_MoveArm_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.MoveArm_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveArm_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.MoveArm_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveArm_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from behavior_tree_msgs.action import MoveArm
...
class MoveArm_SendGoal_Request(metaclass=Metaclass_MoveArm_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'behavior_tree_msgs/MoveArm_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['behavior_tree_msgs', 'action'], 'MoveArm_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from behavior_tree_msgs.action._move_arm import MoveArm_Goal
...
class Metaclass_MoveArm_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.MoveArm_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from behavior_tree_msgs.action import _move_arm
...
class MoveArm_SendGoal(metaclass=Metaclass_MoveArm_SendGoal):
    from behavior_tree_msgs.action._move_arm import MoveArm_SendGoal_Request as Request
    from behavior_tree_msgs.action._move_arm import MoveArm_SendGoal_Response as Response
...
class MoveArm_GetResult_Response(metaclass=Metaclass_MoveArm_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'behavior_tree_msgs/MoveArm_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['behavior_tree_msgs', 'action'], 'MoveArm_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from behavior_tree_msgs.action._move_arm import MoveArm_Result
...
class Metaclass_MoveArm_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.MoveArm_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveArm_GetResult(metaclass=Metaclass_MoveArm_GetResult):
    from behavior_tree_msgs.action._move_arm import MoveArm_GetResult_Request as Request
    from behavior_tree_msgs.action._move_arm import MoveArm_GetResult_Response as Response
...
class Metaclass_MoveArm_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.MoveArm_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveArm_FeedbackMessage(metaclass=Metaclass_MoveArm_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'behavior_tree_msgs/MoveArm_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['behavior_tree_msgs', 'action'], 'MoveArm_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from behavior_tree_msgs.action._move_arm import MoveArm_Feedback
...
class Metaclass_MoveArm(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.MoveArm')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveArm(metaclass=Metaclass_MoveArm):
    ...
    from behavior_tree_msgs.action._move_arm import MoveArm_Goal as Goal
    # The result message defined in the action definition.
    from behavior_tree_msgs.action._move_arm import MoveArm_Result as Result
    # The feedback message defined in the action definition.
    from behavior_tree_msgs.action._move_arm import MoveArm_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from behavior_tree_msgs.action._move_arm import MoveArm_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from behavior_tree_msgs.action._move_arm import MoveArm_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from behavior_tree_msgs.action._move_arm import MoveArm_FeedbackMessage as FeedbackMessage
