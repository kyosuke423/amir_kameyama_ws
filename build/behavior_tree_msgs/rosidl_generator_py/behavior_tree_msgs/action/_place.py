    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'behavior_tree_msgs.action.Place_Goal')
            logger.debug(
...
class Metaclass_Place_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.Place_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Place_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.Place_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Place_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from behavior_tree_msgs.action import Place
...
class Place_SendGoal_Request(metaclass=Metaclass_Place_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'behavior_tree_msgs/Place_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['behavior_tree_msgs', 'action'], 'Place_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from behavior_tree_msgs.action._place import Place_Goal
...
class Metaclass_Place_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.Place_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from behavior_tree_msgs.action import _place
...
class Place_SendGoal(metaclass=Metaclass_Place_SendGoal):
    from behavior_tree_msgs.action._place import Place_SendGoal_Request as Request
    from behavior_tree_msgs.action._place import Place_SendGoal_Response as Response
...
class Place_GetResult_Response(metaclass=Metaclass_Place_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'behavior_tree_msgs/Place_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['behavior_tree_msgs', 'action'], 'Place_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from behavior_tree_msgs.action._place import Place_Result
...
class Metaclass_Place_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.Place_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Place_GetResult(metaclass=Metaclass_Place_GetResult):
    from behavior_tree_msgs.action._place import Place_GetResult_Request as Request
    from behavior_tree_msgs.action._place import Place_GetResult_Response as Response
...
class Metaclass_Place_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.Place_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Place_FeedbackMessage(metaclass=Metaclass_Place_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'behavior_tree_msgs/Place_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['behavior_tree_msgs', 'action'], 'Place_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from behavior_tree_msgs.action._place import Place_Feedback
...
class Metaclass_Place(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'behavior_tree_msgs.action.Place')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Place(metaclass=Metaclass_Place):
    ...
    from behavior_tree_msgs.action._place import Place_Goal as Goal
    # The result message defined in the action definition.
    from behavior_tree_msgs.action._place import Place_Result as Result
    # The feedback message defined in the action definition.
    from behavior_tree_msgs.action._place import Place_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from behavior_tree_msgs.action._place import Place_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from behavior_tree_msgs.action._place import Place_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from behavior_tree_msgs.action._place import Place_FeedbackMessage as FeedbackMessage
