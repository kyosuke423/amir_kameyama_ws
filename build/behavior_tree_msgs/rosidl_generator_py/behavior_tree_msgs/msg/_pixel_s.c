...
bool behavior_tree_msgs__msg__pixel__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("behavior_tree_msgs.msg._pixel.Pixel", full_classname_dest, 35) == 0);
  }
  behavior_tree_msgs__msg__Pixel * ros_message = _ros_message;
  {  // x
...
PyObject * behavior_tree_msgs__msg__pixel__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("behavior_tree_msgs.msg._pixel");
