...
bool behavior_tree_msgs__msg__bb_float64_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("behavior_tree_msgs.msg._bb_float64_array.BBFloat64Array", full_classname_dest, 55) == 0);
  }
  behavior_tree_msgs__msg__BBFloat64Array * ros_message = _ros_message;
  {  // key
  ...
  {  // value
    ...
    if (!std_msgs__msg__float64_multi_array__convert_from_py(field, &ros_message->value)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of BBFloat64Array */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("behavior_tree_msgs.msg._bb_float64_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BBFloat64Array");
  ...
  {  // value
    PyObject * field = NULL;
    field = std_msgs__msg__float64_multi_array__convert_to_py(&ros_message->value);
    if (!field) {
      return NULL;
    }
    {
