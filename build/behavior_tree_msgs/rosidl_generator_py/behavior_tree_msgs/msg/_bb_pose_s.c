...
bool behavior_tree_msgs__msg__bb_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("behavior_tree_msgs.msg._bb_pose.BBPose", full_classname_dest, 38) == 0);
  }
  behavior_tree_msgs__msg__BBPose * ros_message = _ros_message;
  {  // key
  ...
  {  // value
    ...
    if (!geometry_msgs__msg__pose_stamped__convert_from_py(field, &ros_message->value)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of BBPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("behavior_tree_msgs.msg._bb_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BBPose");
  ...
  {  // value
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose_stamped__convert_to_py(&ros_message->value);
    if (!field) {
      return NULL;
    }
    {
