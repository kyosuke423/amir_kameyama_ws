...
bool behavior_tree_msgs__msg__bb_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("behavior_tree_msgs.msg._bb_path.BBPath", full_classname_dest, 38) == 0);
  }
  behavior_tree_msgs__msg__BBPath * ros_message = _ros_message;
  {  // key
  ...
  {  // value
    ...
    if (!nav_msgs__msg__path__convert_from_py(field, &ros_message->value)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of BBPath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("behavior_tree_msgs.msg._bb_path");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BBPath");
  ...
  {  // value
    PyObject * field = NULL;
    field = nav_msgs__msg__path__convert_to_py(&ros_message->value);
    if (!field) {
      return NULL;
    }
    {
